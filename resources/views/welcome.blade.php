...
<div id="wrapper">
    ...
    <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{asset('backend/index.html')}}">Modern</a>
        </div>
        <!-- /.navbar-header -->
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="m_2"><a href="{{route('show.blog')}}"><i class="fa fa-lock"></i> Logout</a></li>
                </ul>
            </li>
        </ul>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="{{asset('backend/index.html')}}"><i class="fa fa-dashboard fa-fw nav_icon"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-laptop nav_icon"></i>Layouts<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('backend/grids.html')}}">Grid System</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-indent nav_icon"></i>Graphas<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('backend/graphs.html')}}">Chart</a>
                            </li>
                            <li>
                                <a href="{{asset('backend/typography.html')}}">Typography</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('backend/inbox.html')}}">Inbox</a>
                            </li>
                            <li>
                                <a href="{{asset('backend/compose.html')}}">Compose email</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="{{route('cities.index')}}"><i class="fa fa-flask nav_icon"></i>Danh sach thanh pho</a>
                    </li>
                    <li>
                        <a href="{{route('customers.index')}}"><i class="fa fa-flask nav_icon"></i>Danh sach khach hang</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-check-square-o nav_icon"></i>Forms<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('backend/forms.html')}}">Basic Forms</a>
                            </li>
                            <li>
                                <a href="{{asset('backend/validation.html')}}">Validation</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('backend/basic_tables.html')}}">Basic Tables</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{asset('backend/media.html')}}">Media</a>
                            </li>
                            <li>
        ...
        <div class="graphs">
            ...
            <div class="span_11">
                ...
                <div class="col-md-6 col_5">
                    ...
                    <!-- map -->
                    <link href="{{(asset('backend/css/jqvmap.css'))}}" rel='stylesheet' type='text/css' />
                    <script src="{{(asset('backend/js/jquery.vmap.js'))}}"></script>
                    <script src="{{(asset('backend/js/jquery.vmap.sampledata.js'))}}" type="text/javascript"></script>
                    <script src="{{(asset('backend/js/jquery.vmap.world.js'))}}" type="text/javascript"></script>
